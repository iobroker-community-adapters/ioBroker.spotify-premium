...
/**
 * Initialize in-memory cache with existing states and objects.
 *
...
/**
 * Get cached state value by name or wildcard.
 *
 * @param {string} name State name or wildcard ending with .*.
 * @returns {ioBroker.State|null|Record<string, ioBroker.State|null>} Cached state value(s).
 */
...
/**
 * Get cached object by state/object name.
 *
 * @param {string} name Object name.
 * @returns {ioBroker.Object|null} Cached object.
 */
...
/**
 * Set value and/or object in cache and persist to ioBroker.
 *
 * @param {string} name State/object name.
 * @param {any} state State value or state object.
 * @param {ioBroker.SettableObject} [obj] Object definition to merge.
 * @returns {Promise<[null, string]>} Promise with namespaced id.
 */
...
/**
 * Update cache from externally changed state and notify listeners.
 *
 * @param {string} id Full id including namespace.
 * @param {ioBroker.State} state Updated state.
 */
...
/**
 * Update cached object from external object changes.
 *
 * @param {string} id Full id including namespace.
 * @param {ioBroker.Object|null} obj Updated object.
 */
...
/**
 * Delete an object from cache and ioBroker.
 *
 * @param {string} id Object id.
 * @returns {Promise<void>} Promise that resolves when deletion is done.
 */
 ...
 *
 * @param {string|RegExp|Array<string|RegExp>} str State name(s) or pattern(s).
 * @param {(event: {id: string, state: ioBroker.State}) => void} obj Callback function.
 * @param {boolean} [triggeredByOtherService] If true, triggers only for ack=false states.
 */
...
/**
 * Set adapter instance for cache module.
 *
